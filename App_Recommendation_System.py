...
if choice == "Đế xuất dựa trên nội dung":
    ...
    st.markdown("<h3 style='text-align: center; color: Yellow;'>Đế xuất dựa trên nội dung</h3>", unsafe_allow_html=True)
    st.write(" ")
    ...
    if submit_button:
        ...
        ## lựa chọn sản phẩm
        st.markdown("<h3 style='text-align: left; color: #0047ab;'>Thông tin sản phẩmn:</h3>", unsafe_allow_html=True)
        ...
        st.markdown("<h3 style='text-align: left; color: #0047ab;'>Có thể bạn thích sản phẩm này không ?:</h3>", unsafe_allow_html=True)
        sim_list = []
    ...
    st.markdown("<h3 style='text-align: center; color: Coral;'>Đề xuất dựa trên sản phẩm</h3>", unsafe_allow_html=True)
    ...
    if submit_button:
        if len(selected_user) ==0:
            ...
            st.markdown("<h1 style='text-align: center; color: yellow;'>"+strtemp+"</h1>", unsafe_allow_html=True)
            # in sản phẩm   
